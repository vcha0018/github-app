!(function () {
  ...
  function w(e, t) {
    ...
    return "inactive" === e.phase
      ? null
      : e instanceof N
      ? x(t, e.source, e.subject, n.orientation, n.inset)
      : null;
  }
  function x(e, t, n, i, r) {
    for (var a = 0, o = 0, l = n, s = t.offsetParent; l && l != s; )
    ...
    var c = getComputedStyle(t),
      u = "horizontal-tb" == c.writingMode,
      m = void 0,
      f = void 0,
      h = void 0;
    "horizontal" == i || ("inline" == i && u) || ("block" == i && !u)
      ? ((m = n.clientWidth),
        (f = o),
        ("rtl" == c.direction || "vertical-rl" == c.writingMode) &&
          (f += t.scrollWidth - t.clientWidth),
        (h = t.clientWidth))
      : ((m = n.clientHeight), (f = a), (h = t.clientHeight));
    var d = (function (e, t) {
        var n = { start: 0, end: 0 };
        if (!e) return n;
        var i = e.split(" "),
  ...
  function M(e, t, n) {
    return e && n
      ? ((t.value / 100) * (e.end - e.start) + e.start - n.start) /
          (n.end - n.start)
      : 0;
  }
  var N = (function (e) {
    ...
    if (e.timeline) {
      ...
      if (i && null != e.startTime && !e.proxy.pending) {
        ...
        r > 0 && i >= a
          ...
          : 0 != r &&
            (t && null !== e.holdTime && (e.startTime = U(e, e.holdTime)),
            (e.holdTime = null));
      }
      K(e),
        (e.previousCurrentTime = W(e, e.proxy.currentTime)),
        "finished" == e.proxy.playState
          ? (e.finishedPromise || (e.finishedPromise = new P()),
            "pending" == e.finishedPromise.state &&
              (n
                ? j(e)
  ...
  function B(e, t) {
    if (e.timeline) {
      ...
      null != r && ((e.startTime = r), (e.holdTime = null), D(e)),
        p(e.timeline, e.animation, Y.bind(e.proxy)),
  ...
  function Y(e) {
    ...
    if (null != e) {
      ...
      ("running" != n && "finished" != n) ||
        (q(t, (W(t, e) - W(t, this.startTime)) * this.playbackRate),
        "finished" == n && 0 != V(t) && (t.holdTime = null),
        H(t, !1, !1));
    ...
    X = (function () {
      ...
      return (
        ...
        (n.reverse = function () {
          var e = G.get(this),
            t = V(e),
            n = e.resetCurrentTimeOnResume ? null : W(e, this.currentTime),
            i = Infinity == F(e),
            r = 0 != t && (t < 0 || n > 0 || !i);
          if (!e.timeline || !r)
            return (
              r && (e.pendingPlaybackRate = -V(e)), void e.animation.reverse()
            );
            ...
            ? ("idle" != this.playState &&
                ((function (e) {
                  e.pendingTask &&
                    ((e.pendingTask = null),
                    D(e),
                    e.readyPromise.reject(L()),
                    O(e),
                    e.readyPromise.resolve(e.proxy));
                })(e),
                e.finishedPromise &&
                  "pending" == e.finishedPromise.state &&
                  e.finishedPromise.reject(L()),
                (e.finishedPromise = new P()),
                e.animation.cancel()),
              (e.startTime = null),
              (e.holdTime = null),
        ...
        t(e, [
                      ...
                      var t = e.animation.effect,
                        ...
                        i = {
                          apply: function (n) {
                            ...
                            var i = n.apply(t);
                            if (e.timeline) {
                              (i.localTime = _(e, i.localTime)),
                                (i.endTime = _(e, i.endTime)),
                                (i.activeDuration = _(e, i.activeDuration));
                              var r = F(e);
                              (i.duration = r
                                ? CSS.percent(
                                    (100 *
              ...
              if (t != e) {
                ...
                if ((l && d(r.timeline, r.animation), s)) {
                  ...
                  switch (n) {
                    ...
                    case "finished":
                      (r.startTime = u),
                        p(r.timeline, r.animation, Y.bind(this));
                      break;
                    case "paused":
                ...
                if ((d(r.timeline, r.animation), (r.timeline = null), l))
                  switch (
                    (null !== i && (r.animation.currentTime = o * F(r)), n)
                  ) {
                    case "paused":
                      r.animation.pause();
                      break;
          ...
          },
          {
            ...
            set: function (e) {
              ...
              if (((e = W(t, e)), t.timeline)) {
                null == W(t, t.timeline.currentTime) &&
                  null != t.startTime &&
                  ((t.holdTime = null), K(t));
          ...
          },
          {
            ...
            get: function () {
              var e = G.get(this);
              return e.timeline
                ? _(e, null != e.holdTime ? e.holdTime : z(e))
                : e.animation.currentTime;
            },
            set: function (e) {
              var t = G.get(this);
          ...
          },
          {
            ...
            get: function () {
              ...
              if (
                ...
                return "paused";
              if (null != t) {
                if (e.animation.playbackRate > 0 && t >= F(e))
                  return "finished";
          ...
          },
          {
            ...
            get: function () {
              ...
              return e.timeline
                ? (e.readyPromise ||
                    ((e.readyPromise = new P()), e.readyPromise.resolve(this)),
  ...
  function $(e, t) {
    if (!e) return null;
    var n = e.split(" ");
    if (!C.includes(n[0]) || (2 == n.length && !n[1].endsWith("%")))
  ...
  function ee(e) {
    ...
    return (
      e["animation-delay"] && (t.start = $(e["animation-delay"], J().offset)),
      e["animation-end-delay"] &&
        (t.end = $(e["animation-end-delay"], Z().offset)),
      t
    );
  }
  function te(e) {
  ...
  var ne = {
    ...
    ie = ["block", "inline", "vertical", "horizontal"],
    re = ["nearest", "root"],
    ae = new ((function () {
      function e() {
      ...
      return (
        ...
        (t.getScrollTimelineOptions = function (e, t) {
          ...
          for (
            ...
            if (a.name == e) {
              ...
              if (o)
                return n({ source: o }, a.axis ? { orientation: a.axis } : {});
            }
          }
          return null;
        }),
        ...
        (t.getViewTimelineOptions = function (e, t) {
          for (
            var n = this.subjectSelectorToViewTimeline.length - 1;
            n >= 0;
            n--
          ) {
            var i = this.subjectSelectorToViewTimeline[n];
            if (i.name == e) {
              var r = this.findPreviousSiblingOrAncestorMatchingSelector(
                t,
                i.selector
              );
        ...
        (t.handleScrollTimelineProps = function (e, t) {
          ...
          if (!e.selector.includes("@keyframes")) {
            ...
            r && (o = this.extractScrollTimelineNames(e.block.contents)),
              i &&
                (l = this.extractMatches(e.block.contents, ne.ANIMATION_NAME)),
              (r && i) ||
                (a &&
                  this.extractMatches(e.block.contents, ne.ANIMATION).forEach(
                    function (t) {
                      var i = n.extractTimelineName(t);
                      i.timelineName && o.push(i.timelineName);
                      var a = n.extractAnimationName(t);
                      a && (i.timelineName || r) && l.push(a),
                        (i.timelineName || r) &&
                          (n.hasDuration(t) ||
          ...
          if (n || i) {
            ...
            if (n)
              for (
                var o,
                  s = l(
                    this.extractMatches(e.block.contents, ne.SCROLL_TIMELINE)
                  );
                !(o = s()).done;
                ...
                1 == parts.length
                  ...
                  : 2 == parts.length &&
                    (ie.includes(parts[0])
                      ? ((c.axis = parts[0]), (c.name = parts[1]))
                      : ((c.axis = parts[1]), (c.name = parts[0]))),
                  a.push(c);
              }
            if (i)
              for (
                var u = this.extractMatches(
                    e.block.contents,
                    ne.SCROLL_TIMELINE_NAME
                  ),
                  m = 0;
                m < u.length;
                m++
                ...
                m < a.length
                  ? (a[m].name = u[m])
                  : a.push({ selector: e.selector, name: u[m] });
            var f = [];
            r &&
              (f = (f = this.extractMatches(
                e.block.contents,
                ne.SCROLL_TIMELINE_AXIS
              )).filter(function (e) {
                return ie.includes(e);
              }));
            for (var h = 0; h < a.length; h++)
              f.length && (a[h].axis = f[h % a.length]);
          ...
          if (n || i) {
            ...
            if (n)
              for (
                var s,
                  c = l(
                    this.extractMatches(e.block.contents, ne.VIEW_TIMELINE)
                  );
                !(s = c()).done;
                ...
                1 == parts.length
                  ...
                  : 2 == parts.length &&
                    (ie.includes(parts[0])
                      ? ((u.axis = parts[0]), (u.name = parts[1]))
                      : ((u.axis = parts[1]), (u.name = parts[0]))),
                  o.push(u);
              }
            if (i)
              for (
                ...
                f < o.length
                  ? (o[f].name = m[f])
                  : o.push({ selector: e.selector, name: m[f], inset: null });
            var h = [],
              d = [];
            a &&
              (h = this.extractMatches(
                e.block.contents,
                ne.VIEW_TIMELINE_INSET
              )),
              r &&
                (d = (d = this.extractMatches(
                  e.block.contents,
                  ne.VIEW_TIMELINE_AXIS
                )).filter(function (e) {
                  return ie.includes(e);
                }));
            for (var p = 0; p < o.length; p++)
              h.length && (o[p].inset = h[p % o.length]),
        ...
        (t.saveRelationInList = function (e, t, i) {
          var r = e.block.contents.includes("animation-delay:"),
            ...
            s = [],
            c = [];
          r && (l = this.extractMatches(e.block.contents, ne.ANIMATION_DELAY)),
            a &&
              (s = this.extractMatches(
                e.block.contents,
                ne.ANIMATION_END_DELAY
              )),
            o &&
              (c = this.extractMatches(
                e.block.contents,
                ne.ANIMATION_TIME_RANGE
              ));
          for (
            var u = Math.max(t.length, i.length, l.length, s.length, c.length),
              m = 0;
            m < u;
            m++
          )
            this.cssRulesWithTimelineName.push(
              n(
                ...
                c.length ? { "animation-time-range": c[m % c.length] } : {}
              )
            );
        }),
        (t.extractScrollTimelineNames = function (e) {
          var t = this,
            n = ne.ANIMATION_TIMELINE.exec(e)[1].trim(),
            i = [];
          return (
            n
              .split(",")
          ...
          if (i) {
            ...
            n = t =
              this.findMatchingEntryInContainer(
                e,
                new Set(
                  this.sourceSelectorToScrollTimeline.map(function (e) {
                    return e.name;
                  })
                )
              ) ||
              this.findMatchingEntryInContainer(
                e,
                new Set(
                  this.subjectSelectorToViewTimeline.map(function (e) {
                    return e.name;
                  })
                )
              );
            ...
            .forEach(function (n) {
              ...
              if (!i.has(n.animationName)) {
                var r = (function (e, t, n) {
                  ...
                  if (!r) return null;
                  var a =
                    ae.getScrollTimelineOptions(r, n) ||
                    ae.getViewTimelineOptions(r, n);
                  return a
                    ? (a.subject &&
                        (function (e, t) {
                          var n = E(t.subject),
                      ...
                      {
                        timeline: a.source ? new v(a) : new N(a),
                        animOptions: i,
                      })
                    : null;
                ...
                i.set(
                  n.animationName,
                  r && r.timeline && n.timeline != r.timeline
                    ? new X(n, r.timeline, r.animOptions)
                    : null
                );
              }
      ...
      value: function (e, t) {
        ...
        if (n instanceof v) {
          if ((l.pause(), n instanceof ViewTimeline)) {
            var c = G.get(s);
            (c.timeRange = te(t.timeRange)),
              r(c.timeRange.start, a),
              r(c.timeRange.end, o);
          }
          s.play();
        }
